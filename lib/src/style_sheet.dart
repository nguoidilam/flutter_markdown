...
class MarkdownStyleSheet {
  ...
  factory MarkdownStyleSheet.fromTheme(ThemeData theme) {
    ...
    return MarkdownStyleSheet(
      ...
      mention: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.normal, color: Color(0xff1242CA)),
  ...
  factory MarkdownStyleSheet.fromCupertinoTheme(CupertinoThemeData theme) {
    ...
    return MarkdownStyleSheet(
      ...
      mention: const TextStyle(fontSize: 16, color: Colors.blue, backgroundColor: Colors.grey),
